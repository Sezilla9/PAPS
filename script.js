...
var firebaseConfig = {
  ...
  function register () {
    ...
    if (validate_field(fname) == false || validate_field(mname) == false || validate_field(lname) == false 
    || validate_field(bday) == false || validate_field(eid) == false || validate_field(password) == false 
